...
public class OrangeHRMApplication_LogInTest extends BaseTest
{
	...
	orangeHRMApplicationPropertiesFile = new FileInputStream("./src/main/java/com/Config/OHRMApplication.properties");
	...
	logInTestDataFile= new FileInputStream("C:\\OrangeHRMApplication\\OrangeHRMApplicationTesting\\src\\main\\java\\com\\OrangeHRMApplicationTestDataFIles\\OrangeHRM_LogInTestDataFile.xlsx");
	...
	logInUserNameRowOfCell=logInTestDataRow.getCell(7);
	...
	logInPasswordRowOfCell=logInTestDataRow.getCell(8);
	...
	testResultFile = new FileOutputStream("C:\\OrangeHRMApplication\\OrangeHRMApplicationTesting\\src\\main\\java\\com\\OrangeHRMApplicationTestResultFIles\\OrangeHRM_LogInTestResultFile.xlsx");
